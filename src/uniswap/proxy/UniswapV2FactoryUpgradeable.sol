...
contract UniswapV2FactoryUpgradeable is Initializable, OwnableUpgradeable, UUPSUpgradeable, IUniswapV2Factory {
    ...
    function setExternalSwapRouter(address _router) external override {
        require(msg.sender == feeToSetter, "TENETSWAPV2 FORBIDDEN");
        externalSwapRouter = _router;
    }
    ...
    function tokenRoyalty(address token) external view override returns (address) {
