...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    string public constant override name = "TENETSWAPV2 LP";
    string public constant override symbol = "TENETSWAPV2-LP";
    ...
    function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s)
        ...
        override
    {
        require(deadline >= block.timestamp, "TENETSWAPV2 EXPIRED");
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, "TENETSWAPV2 INVALID_SIGNATURE");
